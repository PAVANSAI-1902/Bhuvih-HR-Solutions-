    ...
    <div className="font-sans text-gray-800 min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50">
      ...
      <header
        className={`bg-gradient-to-r from-[#FF9933] via-[#FF7F11] to-[#FF4500] text-white shadow-2xl sticky top-0 z-50 transition-all duration-300 ${
          isScrolled ? "py-3 shadow-xl" : "py-4 lg:py-6"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex space-x-1 lg:space-x-2">
              <a
                href="#about"
                className="px-4 py-2 rounded-lg text-white hover:bg-white/20 backdrop-blur-sm transition-all duration-300 font-medium transform hover:scale-105"
              >
                About Us
              </a>
              <a
      ...
      <section className="relative bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute top-40 right-10 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute -bottom-20 left-1/2 w-72 h-72 bg-red-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-left">
              ...
              <div
                className="grid grid-cols-2 sm:grid-cols-4 gap-8 animate-fadeInUp"
                style={{ animationDelay: "0.2s" }}
              >
                <div className="group cursor-pointer text-left">
                  <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    500+
                  </div>
                ...
                <div className="group cursor-pointer text-left">
                  <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    10K+
                  </div>
                  <div className="text-gray-600 font-medium">Placements</div>
                </div>
                <div className="group cursor-pointer text-left">
                  <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    50+
                  </div>
                  <div className="text-gray-600 font-medium">Cities</div>
                </div>
                <div className="group cursor-pointer text-left">
                  <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-600 to-orange-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    98%
                  </div>
            ...
            <div
              className="relative rounded-3xl overflow-hidden shadow-2xl border border-orange-200 animate-fadeInUp"
            ...
            <div className="space-y-6 text-left lg:order-2 lg:pl-8">
              ...
              <div className="grid grid-cols-2 gap-6 mt-8 pt-6 border-t-2 border-gray-200">
                <div className="group text-left p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-red-50 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer">
                  <div className="text-4xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    500+
                  </div>
                ...
                <div className="group text-left p-6 rounded-2xl bg-gradient-to-br from-red-50 to-pink-50 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer">
                  <div className="text-4xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    10K+
                  </div>
      ...
      <section
        id="business"
        className="py-20 lg:py-28 bg-gradient-to-br from-gray-50 via-orange-50/30 to-pink-50/30 relative overflow-hidden"
      >
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 relative overflow-hidden">
        ...
        <div
          className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-orange-300 to-red-300 rounded-full filter blur-3xl opacity-20 -ml-48 -mb-48 animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div
            className="absolute bottom-10 right-10 w-40 h-40 bg-white rounded-full opacity-10 animate-float"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/3 w-24 h-24 bg-white rounded-full opacity-10 animate-float"
            style={{ animationDelay: "2s" }}
          ></div>
        </div>
          ...
          <form onSubmit={handleNewsletterSubmit} className="max-w-xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                ...
                />
                {emailError && (
                  <p className="text-white text-sm mt-2 text-left bg-red-500/20 px-4 py-2 rounded-lg backdrop-blur-sm">
                    {emailError}
                  </p>
                )}
              </div>
      ...
      <section
        id="contact"
        className="py-20 lg:py-28 relative overflow-hidden bg-gradient-to-br from-orange-50 via-red-50 to-pink-50"
      >
        {/* Background decoration */}
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-orange-100">
                <h3 className="text-2xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-8">
                  Contact Information
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-start">
            ...
            <div className="lg:pl-4">
              <h3 className="font-bold mb-6 text-xl bg-gradient-to-r from-white via-green-100 to-white bg-clip-text text-transparent">
            ...
            <div className="lg:pl-4">
              ...
              <ul className="space-y-4 text-white/80">
                <li>
                  ...
                  >
                    <svg
                      className="w-4 h-4 mr-2 text-white group-hover:translate-x-1 transition-transform duration-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                committed to protecting the privacy and confidentiality of users
                who access our platforms including Koluvu, Leko-HRMS, Koluvu
                Technology, and School of HR Excellence.
              </p>
              <p className="text-gray-700 leading-relaxed mt-3">
                This Privacy Policy outlines how we collect, process, use,
                store, and safeguard personal and organizational data.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  Full name, contact number, email, resume, employment history,
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  Organization name, HR contact details, job postings, salary
                  structures, employee performance records.
                </p>
              </div>
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  Browser type, IP address, device information, and cookies for
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  Government IDs, salary data, and performance reviews
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  Enable resume parsing, AI scoring, and job recommendations.
                </li>
                <li>Facilitate employer-candidate connections.</li>
                <li>Ensure legal and compliance reporting.</li>
                <li>
                  Improve product features, AI accuracy, and customer support.
                </li>
                <li>
                  Provide personalized communication, job alerts, and
                  notifications.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>
                  Restricted access with multi-factor authentication for staff.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  <strong>Access & Correction:</strong> View or update personal
                  details.
                </li>
                <li>
                ...
                <li>
                  <strong>Opt-out:</strong> Disable marketing and promotional
                  communications.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  Shared only with verified employers, recruiters, and training
                  partners.
                </li>
        ...
        content={
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Koluvu connects job seekers and employers but does not guarantee
                placements.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Resume parsing, scoring, and job recommendations are
                algorithm-driven and should be treated as guidance.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Bhuvih HR is not liable for fraudulent or misleading employer
                behavior. Candidates should verify employers independently.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Certifications from the School of HR Excellence do not ensure
                employment; they are skill-enhancement initiatives.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Services may experience temporary interruptions for upgrades,
        ...
        content={
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  Recipient must not disclose, copy, or distribute information
                  without written consent.
                </li>
                <li>
                  Information to be used only for intended collaboration or
                  employment purposes.
                </li>
                <li>
                  On termination, all documents must be returned or destroyed.
                </li>
              </ul>
            </div>
